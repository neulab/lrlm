...
class ModuleList(Module, Generic[Mod], Sequence[Mod]):
    def __init__(self, modules: Optional[Iterable[Mod]] = ...) -> None: ...

    @overload
    def __getitem__(self, idx: int) -> Mod: ...

    @overload
    def __getitem__(self: T, idx: slice) -> T: ...

    def __setitem__(self, idx: int, module: Mod) -> None: ...
    ...
    def __iadd__(self: T, modules: Iterable[Mod]) -> T: ...

    def insert(self, index: int, module: Mod) -> None: ...

    def append(self: T, module: Mod) -> T: ...

    def extend(self: T, modules: Iterable[Mod]) -> T: ...


class ModuleDict(Module, Generic[Mod]):
    def __init__(self, modules: Optional[Mapping[str, Mod]] = ...) -> None: ...

    def __getitem__(self, key: str): ...

    def __setitem__(self, key: str, module: Mod) -> None: ...
    ...
    def items(self) -> ItemsView[str, Mod]: ...

    def values(self) -> ValuesView[Mod]: ...

    def update(self, modules: Mapping[str, Mod]) -> None: ...
