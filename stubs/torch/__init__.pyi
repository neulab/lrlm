...
def load(f: Union[str, Path, IO],
         map_location: Optional[Union[Dict[str, str], str, device, Callable[[str, str], str]]] = None,
         pickle_module=pickle, **pickle_load_args): ...


def save(obj: Any, f: Union[str, Path, IO], pickle_module=pickle, pickle_protocol=pickle.DEFAULT_PROTOCOL): ...
...
class Tensor(TensorBase):
    ...
    def split(self, split_size_or_sections: MaybeList[builtins.int], dim: builtins.int = 0) -> List[Tensor]: ...
...
def split(input: Tensor, split_size_or_sections: MaybeList[builtins.int],
          dim: builtins.int = 0) -> List[Tensor]: ...
